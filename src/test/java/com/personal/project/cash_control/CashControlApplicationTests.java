...
class CashControlApplicationTests {
	...
	void shouldReturnACashCardWhenDataIsSaved() {
		 ResponseEntity<String> response = restTemplate.getForEntity("/cashcontrol/99", String.class);
	...
	void shouldNotReturnACashCardWithAnUnknownId() {
	  ResponseEntity<String> response = restTemplate.getForEntity("/cashcontrol/1000", String.class);
